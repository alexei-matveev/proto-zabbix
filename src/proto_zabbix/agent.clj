...
(defn- refresh-active-checks
  ...
  (try
    ...
    ;; well. We could return a list of checks in both cases, empty in
    ;; case of failure. But that would make a failure to contact the
    ;; server and a ligimate lack of checks indistinguishable:
